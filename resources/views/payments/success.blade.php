...
<body>
    @if ($status == 1)
        <h1>You have successfully purchased {{$plan_name}} subscription please click below button to go My Account and start clean files</h1>
        <div>
...
@section('content')
    ...
    <section class="contained">
        ...
        <div class="dashboard-main">
            @if ($status == 1)
                <h1>You have successfully purchased {{ $plan_name }} subscription please click below button to go My
